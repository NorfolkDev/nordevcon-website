...
<li
    @class(["grow-1 relative max-w-3xl shrink-0 overflow-hidden rounded-xl bg-wave-purple", "text-right xl:self-end" => $align === "right"])
>
    <img
    ...
    />
    <div
        class="absolute inset-0 flex flex-col justify-between p-4 text-white sm:p-6 lg:p-8"
    >
        <div>
        ...
        <div>
            <a
                href="https://ti.to/norfolkdevelopers/nordevcon-24/discount/workshop-group"
