...
<dialog class="w-full bg-transparent p-0 backdrop:bg-black backdrop:bg-opacity-50">
    <form class="mx-auto max-w-7xl overflow-hidden rounded-md bg-wave-pink text-white shadow-md" method="dialog">
            ...
            <div class="group flex gap-4">
                <div class="-space-x-12 group-hover:space-x-2">
                    @foreach ($session->speakers as $speaker)
                        <img class="inline-block w-24 rounded-full border-2 border-slate-900 transition-all ease-in-out"
